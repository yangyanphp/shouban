  ...
  <div class="table_full">
    <form method='post'   id="myform" class="J_ajaxForm"  action="<?php echo U('Config/attach');?>">
      ...
      <!-- <tr>
        ...
        <th><input name="ftpstatus" type="radio" value="1"  <?php if( $Site['ftpstatus'] == '1' ): ?>checked<?php endif; ?> /> 开启 <input name="ftpstatus" type="radio" value="0" <?php if( $Site['ftpstatus'] == '0' ): ?>checked<?php endif; ?> /> 关闭</th>
      </tr>
      <tr>
