          ...
          <table width="100%" class="table_form ">
            <tr>
              ...
              <td><select name="info[modelid]" id="modelid">
                  ...
                  <?php if(is_array($models)): $i = 0; $__LIST__ = $models;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["modelid"]); ?>" <?php if( $parentid_modelid == $vo['modelid'] ): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select></td>
            </tr>
            <tr>
          ...
          <table width="100%" class="table_form ">
            <tr id="fmmb">
              ...
              <td><select name="setting[category_template]" id="category_template">
                  ...
                  <?php if(is_array($tp_category)): $i = 0; $__LIST__ = $tp_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            ...
            <tr id="lbmb" style="display:none;">
              ...
              <td><select name="setting[list_template]" id="list_template">
                  ...
                  <?php if(is_array($tp_list)): $i = 0; $__LIST__ = $tp_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            ...
            <tr  id="plmb" style="display:none;">
              ...
              <td><select name="setting[show_template]" id="show_template">
                  ...
                  <?php if(is_array($tp_show)): $i = 0; $__LIST__ = $tp_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
      ...
      <div style="display:none">
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>内容页URL规则：</th>
              <td><div style="display:" id="show_php_ruleid"> <?php echo ($show_php_ruleid); ?> </div>
                <div style="display:none" id="show_html_ruleid"> <?php echo ($show_html_ruleid); ?> </div></td>
            </tr>
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <?php if(is_array($Role_group)): $i = 0; $__LIST__ = $Role_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dt>
                    ...
                    <dd>
                      ...
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="remove,<?php echo ($vo["id"]); ?>" ><span>移动</span></label>
            ...
            <?php if(isModuleInstall('Member')): ?><tr>
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <?php if(is_array($Member_group)): $i = 0; $__LIST__ = $Member_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dt>
                    ...
                    <dd>
                      <label><input  class="J_check" type="checkbox" data-yid="J_check_priv_groupid<?php echo ($vo["groupid"]); ?>"  name="priv_groupid[]" <?php if( $vo['groupid'] == 8 ): ?>disabled<?php endif; ?>  value="add,<?php echo ($vo["groupid"]); ?>" ><span>允许投稿</span></label>
                    </dd><?php endforeach; endif; else: echo "" ;endif; ?>
                  </dl>
                </div></td>
            </tr><?php endif; ?>
