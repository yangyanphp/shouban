          ...
          <table width="100%" class="table_form ">
            <tr>
              ...
              <td><select name="info[modelid]" id="modelid">
                  ...
                  <?php if(is_array($models)): $i = 0; $__LIST__ = $models;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["modelid"]); ?>" <?php if($vo['modelid'] == $data['modelid']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select></td>
            </tr>
            <tr>
            ...
            <tr>
              <th>关闭列表动态访问：</th>
              <td><label><input name="setting[listoffmoving]" type="checkbox" value="1" <?php if($data['setting']['listoffmoving']): ?>checked<?php endif; ?>>关闭前台动态地址访问栏目列表</label></td>
            </tr>
            <tr>
              <th>关闭内容页动态访问：</th>
              <td><label><input name="setting[showoffmoving]" type="checkbox" value="1" <?php if($data['setting']['showoffmoving']): ?>checked<?php endif; ?>>关闭前台动态访问内容页</label></td>
            </tr>
          </table>
        </div>
      </div>
      <div style="display:none">
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>后台增加/编辑信息：</th>
              <td><input type="checkbox"  value="1" <?php if($data['setting']['generatehtml'] == '1' ): ?>checked<?php endif; ?>  name="setting[generatehtml]">
                生成内容页； 生成列表：
                <select name="setting[generatelish]">
                  <option value="0" <?php if($data['setting']['generatelish'] == '0' ): ?>selected<?php endif; ?>>不生成</option>
                  <option value="1" <?php if($data['setting']['generatelish'] == '1' ): ?>selected<?php endif; ?>>生成当前栏目</option>
                  <option value="2" <?php if($data['setting']['generatelish'] == '2' ): ?>selected<?php endif; ?>>生成首页</option>
                  <option value="3" <?php if($data['setting']['generatelish'] == '3' ): ?>selected<?php endif; ?>>生成父栏目</option>
                  <option value="4" <?php if($data['setting']['generatelish'] == '4' ): ?>selected<?php endif; ?>>生成当前栏目与父栏目</option>
                  <option value="5" <?php if($data['setting']['generatelish'] == '5' ): ?>selected<?php endif; ?>>生成父栏目与首页</option>
                  <option value="6" <?php if($data['setting']['generatelish'] == '6' ): ?>selected<?php endif; ?>>生成当前栏目、父栏目与首页</option>
                </select></td>
            </tr>
            <?php if(isModuleInstall('Member')): ?><tr>
              <th>前台投稿审核：</th>
              <td><ul class="switch_list cc ">
                  <li>
                    <label>
                      <input type='radio' name="setting[member_check]" <?php if($data['setting']['member_check'] == '1' ): ?>checked<?php endif; ?> value='1'>
                      <span>需要审核</span></label>
                  </li>
                  <li>
                    <label>
                      <input type='radio' name="setting[member_check]" <?php if($data['setting']['member_check'] == '0' ): ?>checked<?php endif; ?> value='0'>
            ...
            <tr>
              ...
              <td><select name="setting[member_admin]">
                  <option value="0" <?php if($data['setting']['member_admin'] == '0' ): ?>selected<?php endif; ?>>不能管理信息</option>
                <option value="1" <?php if($data['setting']['member_admin'] == '1' ): ?>selected<?php endif; ?>>可管理未审核信息</option>
                <option value="2" <?php if($data['setting']['member_admin'] == '2' ): ?>selected<?php endif; ?>>只可编辑未审核信息</option>
                <option value="3" <?php if($data['setting']['member_admin'] == '3' ): ?>selected<?php endif; ?>>只可删除未审核信息</option>
                <option value="4" <?php if($data['setting']['member_admin'] == '4' ): ?>selected<?php endif; ?>>可管理所有信息</option>
                <option value="5" <?php if($data['setting']['member_admin'] == '5' ): ?>selected<?php endif; ?>>只可编辑所有信息</option>
                <option value="6" <?php if($data['setting']['member_admin'] == '6' ): ?>selected<?php endif; ?>>只可删除所有信息</option>
                </select>
                <input type="checkbox"  value="1" <?php if($data['setting']['member_editcheck'] == '1' ): ?>checked<?php endif; ?> name="setting[member_editcheck]" >
                编辑信息需要审核</td>
            </tr>
            <tr>
              <th>投稿生成列表：</th>
              <td><select name="setting[member_generatelish]">
                  <option value="0" <?php if($data['setting']['member_generatelish'] == '0' ): ?>selected<?php endif; ?>>不生成</option>
                  <option value="1" <?php if($data['setting']['member_generatelish'] == '1' ): ?>selected<?php endif; ?>>生成当前栏目</option>
                  <option value="2" <?php if($data['setting']['member_generatelish'] == '2' ): ?>selected<?php endif; ?>>生成首页</option>
                  <option value="3" <?php if($data['setting']['member_generatelish'] == '3' ): ?>selected<?php endif; ?>>生成父栏目</option>
                  <option value="4" <?php if($data['setting']['member_generatelish'] == '4' ): ?>selected<?php endif; ?>>生成当前栏目与父栏目</option>
                  <option value="5" <?php if($data['setting']['member_generatelish'] == '5' ): ?>selected<?php endif; ?>>生成父栏目与首页</option>
                  <option value="6" <?php if($data['setting']['member_generatelish'] == '6' ): ?>selected<?php endif; ?>>生成当前栏目、父栏目与首页</option>
                </select></td>
            </tr>
            <tr>
              <th>投稿增加点数：</th>
              <td><input type="text" class="input" value="<?php echo ($data['setting']['member_addpoint']); ?>" name="setting[member_addpoint]">
          ...
          <table width="100%" class="table_form ">
            <?php if($data['child']): ?><tr id="fmmb">
              ...
              <td><select name="setting[category_template]" id="category_template">
                  ...
                  <?php if(is_array($tp_category)): $i = 0; $__LIST__ = $tp_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>" <?php if($data['setting']['category_template'] == $vo ): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            ...
            <tr>
              ...
              <td><select name="setting[list_template]" id="list_template">
                  ...
                  <?php if(is_array($tp_list)): $i = 0; $__LIST__ = $tp_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>" <?php if($data['setting']['list_template'] == $vo ): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            ...
            <tr  id="plmb">
              ...
              <td><select name="setting[show_template]" id="show_template">
                  ...
                  <?php if(is_array($tp_show)): $i = 0; $__LIST__ = $tp_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>" <?php if($data['setting']['show_template'] == $vo ): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                <span class="gray">新增模板以show_x<?php echo C("TMPL_TEMPLATE_SUFFIX")?>形式</span></td>
            </tr><?php endif; ?>
            <tr>
              <th>后台信息列表模板：</th>
              <td><input type="text" name="setting[list_customtemplate]" id="catdir" class="input" value="<?php echo ($data['setting']['list_customtemplate']); ?>">
      ...
      <div style="display:none">
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr style="<?php if($setting['ishtml'] == '0' ): ?>display:none<?php endif; ?>"  class="repagenum">
              <th width="200">栏目生成静态页数：</th>
              <td><input type="text" name="setting[repagenum]" id="listorder" class="input" value="<?php echo ($setting["repagenum"]); ?>"> <span class="gray"> 页(超过分页采用动态链接，0为不限)</span></td>
            </tr>
            <?php if($data['child'] == 0): ?><tr>
              <th width="200">内容页生成Html：</th>
              <td><ul class="switch_list cc ">
                  <li>
                    <label>
                      <input type="radio" onClick="$('#show_php_ruleid').css('display','none');$('#show_html_ruleid').css('display','')" value="1" name="setting[content_ishtml]" <?php if($setting['content_ishtml'] == '1' ): ?>checked<?php endif; ?>>
                      <span>内容页生成静态</span></label>
                  </li>
                  <li>
                    <label>
                      <input type="radio" onClick="$('#show_php_ruleid').css('display','');$('#show_html_ruleid').css('display','none')"  value="0" name="setting[content_ishtml]" <?php if($setting['content_ishtml'] == '0' ): ?>checked<?php endif; ?>>
            ...
            <tr>
             ...
             <?php if($data['child'] == 0): ?><tr>
              <th>内容页URL规则：</th>
              <td><div style="<?php if($setting['content_ishtml'] == '1' ): ?>display:none<?php endif; ?>" id="show_php_ruleid"> <?php echo ($show_php_ruleid); ?> </div>
                <div style="<?php if($setting['content_ishtml'] == '0' ): ?>display:none<?php endif; ?>" id="show_html_ruleid"> <?php echo ($show_html_ruleid); ?> </div></td>
            </tr><?php endif; ?>
        ...
        <div class="table_full">
          <table width="100%" >
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <?php if(is_array($Role_group)): $i = 0; $__LIST__ = $Role_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dt>
                    ...
                    <dd>
                      ...
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'remove',$vo['id'],1);?> value="remove,<?php echo ($vo["id"]); ?>" ><span>移动</span></label>
            ...
            <?php if(isModuleInstall('Member')): ?><tr>
              ...
              <td><div class="user_group J_check_wrap">
                  <dl>
                  <?php if(is_array($Member_group)): $i = 0; $__LIST__ = $Member_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dt>
                      <label><input type="checkbox" data-direction="y" data-checklist="J_check_priv_groupid<?php echo ($vo["groupid"]); ?>" class="checkbox J_check_all" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?> /><?php echo ($vo["name"]); ?></label>
                    </dt>
                    <dd>
                      <label><input  class="J_check" type="checkbox" data-yid="J_check_priv_groupid<?php echo ($vo["groupid"]); ?>"  name="priv_groupid[]" <?php if( $vo['groupid'] == 8 ): ?>disabled<?php endif; ?> <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'add',$vo['groupid'],0);?>  value="add,<?php echo ($vo["groupid"]); ?>" ><span>允许投稿</span></label>
                    </dd><?php endforeach; endif; else: echo "" ;endif; ?>
                  </dl>
                </div></td>
            </tr><?php endif; ?>
