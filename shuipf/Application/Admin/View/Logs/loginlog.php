...
<div class="wrap J_check_wrap">
  ...
  <div class="search_type cc mb10">
    ...
    <select class="select_2" name="status" style="width:70px;">
      ...
      时间：
      <input type="text" autocomplete="off" name="start_time" class="input length_2 J_date" value="{$_GET.start_time}" style="width:80px;">
      -
      <input type="text" autocomplete="off" class="input length_2 J_date" name="end_time" value="{$_GET.end_time}" style="width:80px;">
