...
<div class="lsList">
	...
	<form name="myform" class="J_ajaxForm" action="{:U('edit')}&id={$info[id]}" method="post">
    	<li>
        	<span><em>*</em>排序号</span>
            <input type="text" name="sort" value="{$info.sort}" class="listText" style="width:50px;text-align:center;"/>
        </li>
        ...
        <li>
            ...
            <input type="text" name="title" value="{$info.title}" class="listText" />
        </li>
        
        <li>
        	<span>关联关键词<i>(关联关键词与URL选填一项)</i></span>
            <input name="keyword" type="text" value="{$info.keyword}" class="listText" />
        </li>
        
        <li>
        	<span>关联URL<i>(关联关键词与URL选填一项)</i></span>
            <input name="url" type="text" value="{$info.url}" class="listText" />
        </li>
