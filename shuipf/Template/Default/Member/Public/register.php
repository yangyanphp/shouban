        ...
        <form onSubmit="return false;">
          <li>
            ...
            <div id="loginName" class="input ">
              <input value="123466" id="username" class="input_normal" type="text" name="username"/>
            </div>
          ...
          <li>
            ...
            <div id="loginEmail" class="input ">
              <input value="123466@qq.com" id="remail" class="input_normal" type="text" name="remail"/>
            </div>
            <div id="memail"></div>
          </li>
          <li>
            ...
            <div id="loginName" class="input">
              <input  value="123466" id="rpassword" class="input_normal" type="password" maxlength="20" name="rpassword"/>
            </div>
          ...
          <li>
            ...
            <div id="loginName" class="input">
              <input value="123466" id="rpassword2" class="input_normal" type="password" maxlength="20" name="rpassword2"/>
            </div>
          ...
          <li>
            ...
            <div id="loginName" class="input">
              <input value="啊啊"id="rnickname" class="input_normal" type="text" maxlength="20" name="rnickname"/>
            </div>
