<div class="footer footer-ny">
    <div class="w1380 partner">
        <div class="title">
            <span class="zuo"></span>
            <h4>{:getCategory(29,'catname')}</h4>
            <span class="you"></span>
        </div>
        <ul class="clearfix">
        <content action="lists" catid="29" order="listorder asc">
            <volist name="data" id="vo">
            <li><a href="{$vo.url}" target="_blank"><img src="{$vo.thumb}" alt=""/></a></li>
            </volist>
        </content>
        </ul>
    </div>
    <div class="w1380 footer-matter">
        <div class="footer-matter-top clearfix">
            ...
            <content action="lists" catid="25" order="listorder asc">
                <volist name="data" id="vo">
